...
public enum EngineMessage {
    ...
    ACTION_TYPE_FAILED_ILLEGAL_CONSOLE_DISCONNECT_ACTION_DELAY(ErrorType.BAD_PARAMETERS),
    ...
    VALIDATION_PARALLEL_MIGRATIONS_RANGE(ErrorType.BAD_PARAMETERS),
    VALIDATION_PARALLEL_MIGRATIONS_NO_DEFAULT(ErrorType.BAD_PARAMETERS),
    ...
    VM_POOL_CANNOT_ATTACH_TO_VM_WITH_ACTIVE_CONSOLE(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_PASSWORD_CANNOT_BE_RESET_FOR_GROUP(ErrorType.BAD_PARAMETERS),
    ...
    ACTION_TYPE_FAILED_DISK_IS_BEING_CONVERTED(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_NOT_ENOUGH_HOSTS_FOR_MIGRATION(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_CANNOT_SCREENSHOT_HEADLESS_VM(ErrorType.CONFLICT),
    ...
    HOT_PLUG_CPU_IS_NOT_SUPPORTED_DEDICATED(ErrorType.NOT_SUPPORTED),
    ...
    ACTION_TYPE_FAILED_CONVERT_DISK_NO_FORMAT_CHANGE(ErrorType.CONFLICT),
    ACTION_TYPE_FAILED_CONVERT_DISK_NO_ALLOCATION_CHANGE(ErrorType.CONFLICT),
    ACTION_TYPE_FAILED_DISK_WITH_CHAIN(ErrorType.NOT_SUPPORTED),
    ...
    VAR__DETAIL__NOT_ENOUGH_CORES_PER_SOCKET_FOR_RESIZE_AND_PIN,
    VAR__DETAIL__NOT_ENOUGH_THREADS_PER_CORE_FOR_DEDICATED,
    VAR__DETAIL__VM_PINNING_PCPU_DOES_NOT_EXIST,
    VAR__DETAIL__VM_PINNING_DEDICATED_NOT_FIT,
    VAR__DETAIL__VM_PINNING_CANT_RESIZE_WITH_DEDICATED,
    ...
    VAR__DETAIL__MISSING_VDS_HOOK,
    VAR__DETAIL__NO_HOST_CPU_DATA,
    SCHEDULING_NO_HOSTS,
    ...
    ACTION_TYPE_MDEV_INVALID_PARAMS(ErrorType.BAD_PARAMETERS),
    ...
    ACTION_TYPE_FAILED_CLUSTER_UPGRADE_NOT_STARTED,
    ACTION_TYPE_CLUSTER_UPGRADE_PERCENT_COMPLETE_INVALID,
    ACTION_TYPE_FAILED_CLUSTER_UPGRADE_CORRELATION_MISMATCH,
    ...
    ACTION_TYPE_FAILED_CANNOT_CLONE_RUNNING_VM_WITH_MBS_DISKS(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_HOSTED_ENGINE_VM_BACKUP_NOT_SUPPORTED(ErrorType.CONFLICT),
    ACTION_TYPE_FAILED_ACTIVE_IMAGE_TRANSFER_FOR_VM_BACKUP(ErrorType.CONFLICT);
