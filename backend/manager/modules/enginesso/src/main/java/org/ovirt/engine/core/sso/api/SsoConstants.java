...
public class SsoConstants {
    ...
    public static final String APP_ERROR_ENCRYPTED_CREDENTIALS_REQUIRED = "ENCRYPTED_CREDENTIALS_REQUIRED";
    public static final String APP_ERROR_PASSWORDS_DONT_MATCH = "PASSWORDS_DONT_MATCH";
    public static final String APP_ERROR_PASSWORD_POLICY_VIOLATION = "PASSWORD_POLICY_VIOLATION";
    ...
    public static final String APP_ERROR_REST_ADMIN_LOGIN_DISABLED = "REST_ADMIN_LOGIN_DISABLED";
    ...
    public static final String APP_ERROR_SINGLE_SESSION_ALREADY_ACTIVE = "SINGLE_SESSION_ALREADY_ACTIVE";
