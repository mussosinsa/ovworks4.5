...
public class MenuPresenterWidget extends PresenterWidget<MenuPresenterWidget.ViewDef> implements MenuDetailsProvider {
    ...
    public interface ViewDef extends View {
        ...
        HasClickHandlers getSecuritySettingsItem();
    ...
    private final Provider<SecuritySettingsPopupPresenterWidget> securitySettingsPopupProvider;
    ...
    public MenuPresenterWidget(EventBus eventBus,
            ...
            Provider<SecuritySettingsPopupPresenterWidget> securitySettingsPopupProvider,
            OptionsProvider optionsProvider) {
        super(eventBus, view);
        this.configurePopupProvider = configurePopupProvider;
        this.securitySettingsPopupProvider = securitySettingsPopupProvider;
    ...
    public void onBind() {
        ...
        registerHandler(getView().getSecuritySettingsItem()
                .addClickHandler(event -> RevealRootPopupContentEvent.fire(MenuPresenterWidget.this,
                        securitySettingsPopupProvider.get())));
